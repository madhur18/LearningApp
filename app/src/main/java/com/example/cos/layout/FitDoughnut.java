...
package com.example.cos.layout;
...
public class FitDoughnut extends ViewGroup {
    ...
    private final Property<FitDoughnut, Float> percentProperty = new Property<FitDoughnut, Float>(Float.class, "Percent") {
        @Override
        public Float get(FitDoughnut fd) { return fd.getPercent(); }
        @Override
        public void set(FitDoughnut fd, Float value) { fd.setPercent(value); }
    };
    ...
    private final Property<FitDoughnut, Float> originAngleProperty = new Property<FitDoughnut, Float>(Float.class, "OriginAngle") {
        @Override
        public Float get(FitDoughnut fd) { return fd.getOriginAngle(); }
        @Override
        public void set(FitDoughnut fd, Float value) { fd.setOriginAngle(value); }
    };
    ...
    private final ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
        @Override
        public void onAnimationUpdate(ValueAnimator valueAnimator) { fitDoughnutView.invalidate(); }
    };
